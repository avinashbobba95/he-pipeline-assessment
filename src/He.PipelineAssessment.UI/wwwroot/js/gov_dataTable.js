...
function initAssessmentListDataTable(tableId, columnNumberToSort, searchElementId) {
    $('#' + tableId).DataTable({
        ajax: {
            url: "Assessment/GetAssessmentList",
            type: "POST",
        },
        processing: true,
        serverSide: true,
        columns: [
            ...
            { data: "Counterparty" },
            { data: "LocalAuthority"},
            { data: "FundingAskCurrency"},
            { data: "NumberOfHomesFormatted"},
            { data: "ProjectManager"},
            { data: "LastModifiedDateTime"},
            { data: "StatusDisplayTag"},
        ],
        "bLengthChange": false,
        order: [[columnNumberToSort, 'asc']],
        "columnDefs": [
